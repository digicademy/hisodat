...
/**
 * Localities of the source corpus
 */
class Localities extends AbstractEntity
{
    ...
    /**
     * Any name variants of the locality
     *
    ...
    /**
     * A locality can be dated to a specific time period
     *
    ...
    /**
     * Localities can be associated with keywords
     *
